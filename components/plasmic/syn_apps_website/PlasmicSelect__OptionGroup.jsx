...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 8OhaiNWOT655/css
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__jHsVi)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option___9JkHg)}
              />
            </React.Fragment>
          ),
