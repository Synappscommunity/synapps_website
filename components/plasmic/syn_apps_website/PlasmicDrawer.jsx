...
import Button2 from "../../Button2"; // plasmic-import: nCt4jFntNzpF/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: RfvNCco5N0To/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_IVdUCfoCW02h"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__nvAk2)}>
              {$props.showHeading ? (
                <BaseHeading
                ...
                {renderPlasmicSlot({
                  defaultContents: (
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__lZuM)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__nGiMx)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__h8Bb7)}
                    >
                      <Button2
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button2
                  className={classNames("__wab_instance", sty.button2___2RmVm)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
